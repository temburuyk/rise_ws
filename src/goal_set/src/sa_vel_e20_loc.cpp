...
{
  current_local_pos.position.x=0; //msg->x;
  current_local_pos.position.y=0; //msg->y;
  current_pos_in_map.position.x= current_local_pos.position.x- previous_local_pos.position.x+20;
  current_pos_in_map.position.y=current_local_pos.position.y- previous_local_pos.position.y+2;
}
