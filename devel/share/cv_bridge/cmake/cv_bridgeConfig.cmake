...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/yashwant/rise_ws/src/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/yashwant/rise_ws/devel)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/yashwant/rise_ws/install)
...
if(NOT "/home/yashwant/rise_ws/src/cv_bridge/include;/usr/include/opencv;/usr/include " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/yashwant/rise_ws/src/cv_bridge/include;/usr/include/opencv;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yashwant/rise_ws/src/cv_bridge/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
