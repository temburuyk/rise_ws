...
(cl:defmethod cl:initialize-instance :after ((m <roboteq_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'roboteq_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboteq-msg:<roboteq_msg> is deprecated: use roboteq-msg:roboteq_msg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <roboteq_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboteq-msg:header-val is deprecated.  Use roboteq-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'rpm_1-val :lambda-list '(m))
(cl:defmethod rpm_1-val ((m <roboteq_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboteq-msg:rpm_1-val is deprecated.  Use roboteq-msg:rpm_1 instead.")
  (rpm_1 m))

(cl:ensure-generic-function 'rpm_2-val :lambda-list '(m))
(cl:defmethod rpm_2-val ((m <roboteq_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboteq-msg:rpm_2-val is deprecated.  Use roboteq-msg:rpm_2 instead.")
  (rpm_2 m))

(cl:ensure-generic-function 'encoder_1-val :lambda-list '(m))
(cl:defmethod encoder_1-val ((m <roboteq_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboteq-msg:encoder_1-val is deprecated.  Use roboteq-msg:encoder_1 instead.")
  (encoder_1 m))

(cl:ensure-generic-function 'encoder_2-val :lambda-list '(m))
(cl:defmethod encoder_2-val ((m <roboteq_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboteq-msg:encoder_2-val is deprecated.  Use roboteq-msg:encoder_2 instead.")
  (encoder_2 m))

(cl:ensure-generic-function 'mxrpm-val :lambda-list '(m))
(cl:defmethod mxrpm-val ((m <roboteq_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboteq-msg:mxrpm-val is deprecated.  Use roboteq-msg:mxrpm instead.")
  (mxrpm m))
